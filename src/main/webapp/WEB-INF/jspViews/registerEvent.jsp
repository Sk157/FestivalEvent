...
function getSeats(){
	  ...
	  var z = document.forms["myform"]["noOfSeats"].value;
...
<body>
	<center>
		<table>
			...
			<tr>
				<td>
				<form name="myform" action="confirmSeats.html" method="post">
					<input type="hidden" name="visitorId" value="${visitorId}"/>
					<input type="hidden" name="eventId" value="${event.eventId}"/>
					No of Seats:&nbsp; <input type="number" name="noOfSeats" size="1"/><br>
					<div colspan="3" align="right"><input type="submit" value="Get Seats" onclick="getSeats()"></div><br><br />
				</form>
